  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Plan estratégico de seguridad vial
        p.mb-4 Identificar y manejar los conceptos que se utilizan al momento de elaborar los planes estratégicos de seguridad vial y que son indispensables en el área del  transporte y la seguridad vial.
